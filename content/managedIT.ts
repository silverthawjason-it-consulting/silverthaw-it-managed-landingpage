  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        extended:
          "We begin with an assessment of your current environment and where your business is headed. From there, the Silverthaw team build a managed IT services package tailored to your operations, then take full ownership of your technology: helpdesk, security, infrastructure, and strategic planning.",
        bullets: [
      ...
      },
      {
        ...
        summary:
          "Continuous cybersecurity services for your data, devices, and team, monitored around the clock and managed on your behalf. Enterprise-grade IT security services without the enterprise-grade budget.",
        extended:
