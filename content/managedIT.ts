...
const managedIT: LandingPageContent = {
  ...
  hero: {
    ...
    subheadline:
      "Silverthaw Consulting delivers managed IT services for small and medium businesses across Toronto and Ontario. We take full ownership of your technology — IT support, cybersecurity, infrastructure, and software strategy — under one proactive, always-on partnership. So you can stop managing technology and get back to running your business.",
  ...
  services: {
    ...
    headingLines: ["Everything Your Business", "Needs. Under One Roof."],
    subheadline:
  ...
  advantage: {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Most businesses juggle three to five IT vendors with no single owner of the full picture. Silverthaw changes that. One partner holds your infrastructure, security, software, and strategy — with a the dedicated advisor who owns the relationship and coordinates every specialist working on your behalf. One call. Full accountability.",
      },
    ],
    closing: {
