...
const itSupportSmallBusiness: LandingPageContent = {
  ...
  faq: {
    ...
    items: [
      {
        q: "What does outsourced IT support actually include?",
        a: "Most people picture IT support as help desk tickets and antivirus. Silverthaw runs as a full outsourced IT support team, covering practical planning, network monitoring, cybersecurity, cloud and infrastructure support, software selection, and end-user support. Unlike a break-fix vendor, we own every layer of your technology and the outcome it produces.",
      },
      {
      ...
      },
      {
        ...
        a: "We love working alongside in-house teams. Think of us as a trusted extension of your IT support, covering practical planning, security hardening, vendor management, and after-hours support. Your person gets real backup, and can focus on what only they know about your business.",
      },
      {
      ...
      {
        q: "Is IT support better than in-house IT?",
