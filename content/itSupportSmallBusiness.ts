...
const itSupportSmallBusiness: LandingPageContent = {
  ...
  hero: {
    ...
    subheadline:
      "Silverthaw Consulting delivers reliable IT support for small businesses across Toronto and Ontario. We take full ownership of your technology — helpdesk, cybersecurity, infrastructure, and software guidance — under one responsive, always-on partnership. So you can stop fighting with technology and get back to running your business.",
    ...
    items: [
      {
        ...
        summary:
          "Launch with dependable IT support for your small business in place from day one. We build your technology foundation — hardware, software, cloud, and security — lean, protected, and ready to scale from the moment you open the doors.",
        extended:
          "Getting your technology right at the start saves years of costly fixes later. We set up your complete IT foundation and provide ongoing small business IT support so your business is operational, protected, and ready to grow — without building an internal team to manage it.",
        bullets: [
      ...
      },
      {
        ...
        extended:
          "We begin with an assessment of your current environment and where your business is headed. From there, the Silverthaw team build an IT support package tailored to your operations — and take full ownership of your technology: helpdesk, security, infrastructure, and day-to-day support.",
        bullets: [
      ...
      },
      {
        ...
        summary:
          "Continuous cybersecurity for your data, devices, and team — monitored around the clock, managed on your behalf. Enterprise-grade protection for small businesses without the enterprise-grade budget.",
        extended:
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "That's actually when you need it most. Small businesses are the primary targets for cyberattacks precisely because they're unprotected. And the technology decisions you make now — your systems, your security, your data practices — become the foundation everything else is built on. Getting it right from the start costs a fraction of fixing it later.",
      },
      {
